export default function WIP() {
  return(
    <>
      <div className="bg-blue-200 dark:bg-blue-950 h-full nav-margin text-center">
        <img className="h-auto mx-auto max-w-xl rounded-lg shadow-xl dark:shadow-gray-800" src="https://wompampsupport.azureedge.net/fetchimage?siteId=7575&v=2&jpgQuality=100&width=700&url=https%3A%2F%2Fi.kym-cdn.com%2Fentries%2Ficons%2Ffacebook%2F000%2F041%2F943%2F1aa1blank.jpg" alt="image description" />
