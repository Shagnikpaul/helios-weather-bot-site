      ...
      <div className=" flex flex-row mx-5  flex-wrap justify-center h-screen space-y-64">
        ...
        <div className="left flex flex-col justify-center h-full m-10 mt-16">
          ...
          <div className="flex flex-row justify-center">
              <div className="backdrop-blur-lg mb-11 max-w-2xl p-11 bg-cardbg/15 morerou dark:bg-cardbg-dark/30 border-borc/10 dark:border-borc-dark/10 shadow-[0_0_50px_-10px_rgba(0,0,0,0.15)]">
              <a href="https://github.com/Shagnikpaul/helios-weather-bot">
                  <h5 className="mb-2 font-bold tracking-tight text-textaccents dark:text-textaccents-dark text-6xl">Helios</h5>
              </a>
              <p className=" text-textaccents/50 dark:text-textaccents-dark/50 font-medium text-lg">A Discord Weather Bot.</p>
              <p className="mb-3 font-normal text-textaccents dark:text-textaccents-dark/80 text-2xl sm:text-3xl pt-5">
        ...
        <div className="d"> 
            <h1 className="-mt-64 mb-4 text-5xl font-bold leading-none tracking-tight text-textaccents md:text-5xl lg:text-7xl dark:text-textaccents-dark">Invite me to get started!</h1>
            <p className="mb-20 text-lg font-medium text-minoraccents lg:text-xl sm:px-16 xl:px-48 dark:text-minoraccents-dark">😇 Free, forever, no paid features.</p>
            <div className="flex flex-row flex-wrap justify-center gap-4">



                <a data-tooltip-target="tooltip-animation" href="https://discord.com/api/oauth2/authorize?client_id=1045392740499853312&permissions=429497117776&scope=bot" className="inline-flex items-center justify-center px-10 py-3 text-base font-semibold text-center text-buttonText dark:text-buttonText-dark bg-buttonMajor dark:bg-buttonMajor-dark rounded-lg hover:bg-buttonMajor/80 dark:hover:bg-buttonMajor-dark/80  focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                Invite
                </a>

                <div id="tooltip-animation" role="tooltip" className="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-500 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                ...
                <div id="tooltip-animation2" role="tooltip" className="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-500 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
